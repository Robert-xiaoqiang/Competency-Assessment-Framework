...
'''
    CLTrainer will use itraration based modal suspend/resume, which
...
class CLTrainer(Trainer):
    def __init__(self, model, tokenizer, train_examples, train_features, train_dataset, train_dataloader,
        ...
        self.num_train_batch_per_epoch = None # it is incompatible with CL setting
        self.num_epochs = None # as above
        self.num_iterations = len(train_dataloader) # because of our custimized batch_sampler
